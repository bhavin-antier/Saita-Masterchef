...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function setSaitamaReferral(ISaitamaReferral _SaitamaReferral)
        public
        onlyOwner
    {
    ...
    function payReferralCommission(address _user, uint256 _pending) internal {
        if (
            address(SaitamaReferral) != address(0) && referralCommissionRate > 0
        ) {
            ...
            if (referrer != address(0) && commissionAmount > 0) {
                ...
                SaitamaReferral.recordReferralCommission(
                    referrer,
                    commissionAmount
                );
